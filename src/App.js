...
function App() {
  return (
    ...
    <div class="container d-flex flex-column align-items-center">
      <img class="header__avatar" src="./avatar.png" alt="avatar" />
      ...
      <div class="row">
        <div class="image mt-4 col-sm-6 col-lg-3">
          <a href="" class="image__link">
            <img src="img1.jpg" alt="" class="image__style" />
          </a>
          <p class="image_title">Place 1</p>
        </div>
        <div class="image mt-4 col-sm-6 col-lg-3">
          <a href="" class="image__link">
            <img src="img2.jpg" alt="" class="image__style" />
          </a>
          <p class="image_title">Place 2</p>
        </div>
        <div class="image mt-4 col-sm-6 col-lg-3">
          <a href="" class="image__link">
            <img src="img3.jpg" alt="" class="image__style" />
          </a>
          <p class="image_title">Place 3</p>
        </div>
        <div class="image mt-4 col-sm-6 col-lg-3">
          <a href="" class="image__link">
            <img src="img4.jpg" alt="" class="image__style" />
          </a>
          <p class="image_title">Place 4</p>
        </div>
        <div class="image mt-4 col-sm-6 col-lg-3">
          <a href="" class="image__link">
            <img src="img5.jpg" alt="" class="image__style" />
          </a>
          <p class="image_title">Place 5</p>
        </div>
        <div class="image mt-4 col-sm-6 col-lg-3">
          <a href="" class="image__link">
            <img src="img6.jpg" alt="" class="image__style" />
          </a>
          <p class="image_title">Place 6</p>
        </div>                
        <div class="image mt-4 col-sm-6 col-lg-3">
          <a href="" class="image__link">
            <img src="img7.jpg" alt="" class="image__style" />
          </a>
          <p class="image_title">Place 7</p>
        </div>
        <div class="image mt-4 col-sm-6 col-lg-3">
          <a href="" class="image__link">
            <img src="img8.jpg" alt="" class="image__style" />
          </a>
